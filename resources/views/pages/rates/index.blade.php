                ...
                <form id="daily-rates-form" method="POST" action="{{ route('admin.rates.store') }}">
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-md border border-gray-200 mb-8">
                        <div class="flex justify-between mb-5">
                            ...
                            <button type="submit" class="bg-yellow-500 hover:bg-yellow-600 text-black font-bold px-8 py-3
                    ...
                    <div
                        ...
                        <div class="flex items-end space-x-4">
                            <div class="flex flex-col flex-1">
                                ...
                                <div class="relative w-full">
                                    ...
                                    <input type="number" name="manual_base_cost" id="manual_base_cost" {{-- 🟢 LOAD SAVED
                                        MANUAL COST HERE --}}
                                        value="{{ ($defaultData['manual_base_cost'] ?? 0.00) > 0 ? number_format($defaultData['manual_base_cost'], 2, '.', '') : '' }}"
                                        min="0" step="0.01" {{-- FIX: Border and Focus classes changed to green --}}
                        ...
                        <p class="text-yellow-700 text-xs mt-2">
                            Enter a value and click 'Apply & Save Override'. All rates below will instantly adjust and save
                            to the database.
                        </p>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-md border border-gray-200 mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div id="wholesale_rate_container">
                                ...
                                @endphp
                                <p class="{{ $wTextColor }} text-xs mt-1" data-margin="0.00"
                            ...
                            @foreach($wholesales as $item)
                                <div>
                                    ...
                                    @endphp
                                    <p class="{{ $textColor }} text-xs mt-1" data-margin="{{ $item['data_margin'] }}"
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-md border border-gray-200 mb-10">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                @endphp
                                <p class="{{ $lcTextColor }} text-xs mt-1" data-margin="0.00"
                                    data-formula="{{ htmlspecialchars($lcRateFormulaText) }}" data-key="live_chicken_rate">
